...
from src.domains.auth.config import ACCESS_TOKEN_EXPIRE, ALGORITHM, PWD_DEPRECATED, PWD_SCHEMES
from src.domains.auth.constants import (
    CLAIM_EXPIRATION,
    CLAIM_ISSUED_AT,
    CLAIM_SUBJECT,
    CLAIM_TYPE,
...
def validate_password_strength(password: str) -> None:
    ...
    """
    from src.domains.auth.exceptions import WeakPasswordException
